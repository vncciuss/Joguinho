    ...
    public void Viajar(){
        ...
        do {
            ...
            switch (escolha2) {
                case "1":
                    System.out.println();
                    System.out.println(nomeJogador + ": Ei, desculpe interromper, mas você trabalhava nesta fábrica, certo?");
                    System.out.println("Ex-funcionário da fábrica: Sim, eu costumava ser um dos operários. O que você quer saber?");
                    System.out.println(nomeJogador + ": Enquanto explorava a fábrica, percebi que muitas das estruturas e máquinas estão em péssimo estado. Algumas delas até parecem estar desmoronando. Você tem alguma ideia do que poderia ter causado isso?");
                    ...
                    System.out.println(nomeJogador + ": Concordo. É importante aprender com os erros do passado para evitar danos ainda maiores ao meio ambiente.");
                    break;
                case "2":
                    System.out.println();
                    System.out.println(nomeJogador + ": Ei, desculpe interromper, mas você trabalhava nesta fábrica, certo?");
                    System.out.println("Ex-funcionário da fábrica: Sim, trabalhei aqui por anos. Em que posso ajudar?");
                    System.out.println(nomeJogador + ": Enquanto explorava os arredores da fábrica, percebi muitos resíduos tóxicos e materiais abandonados. Parece que o local foi negligenciado por muito tempo. Você acha que isso pode ter causado danos ao meio ambiente?");
                    ...
                    System.out.println(nomeJogador + ": Concordo. É hora de tomar medidas para limpar este lugar e restaurar o equilíbrio ambiental.");
                    break;
                case "3":
                    System.out.println();
                    System.out.println(nomeJogador + ": Ei, desculpe interromper, mas você trabalhava nesta fábrica, certo?");
                    System.out.println("Ex-funcionário da fábrica: Sim, eu conheço este lugar como a palma da minha mão. Em que posso ajudar?");
                    System.out.println(nomeJogador + ": Enquanto explorava os arredores da fábrica, cheguei perto do rio que passa por aqui. Fiquei chocado ao ver como as águas estão poluídas e como a vida selvagem está sofrendo. Você tem alguma ideia do que poderia ter causado essa contaminação?");
        ...
        System.out.println();
        System.out.println("Você liderou uma equipe de voluntários na limpeza dos arredores da fábrica abandonada, removendo resíduos tóxicos e materiais abandonados. \nEles também descontaminaram o rio próximo, restaurando a vida aquática. Por meio de campanhas educativas, conscientizaram a comunidade sobre a importância da preservação ambiental. \nAs suas ações transformaram a fábrica de um símbolo de decadência em um exemplo de renovação e esperança.");
        System.out.println();
