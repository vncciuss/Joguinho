    ...
    public void Viajar(){
        ...
        do {
            if(Parque.getConcluido() == false || Fabrica.getConcluido() == false || Ferrovia.getConcluido() == false || Cinema.getConcluido() == false || Praia.getConcluido() == false){
                ...
                System.out.println("\nCom determinação e coragem, o jogador salvou a cidade. Seu compromisso com a preservação ambiental e suas ações decisivas trouxeram esperança e renovação. Agora, a cidade floresce novamente, graças à sua intervenção salvadora.");
