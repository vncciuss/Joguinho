...
public class Calcule extends Jogos {
    public static boolean jogar() {
        ...
        System.out.println();
        do{
            int numero1 = random.nextInt(10); // Número aleatório de 0 a 9
            int numero2 = random.nextInt(10); // Número aleatório de 0 a 9
    ...
    private static int calcularResultado(int num1, int num2, char operador) {
        switch (operador) {
            ...
            case '*':
                return num1 * num2;
            default:
                return 0; // Isso não deveria acontecer, mas retorna 0 por padrão
        }
    }
}
