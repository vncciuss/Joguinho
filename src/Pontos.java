...
public class Pontos {
    ...
    public void darPontuação() {
        ...
        System.out.println();
        System.out.println("Parabéns! Suas ações eficientes ajudaram a revitalizar o ambiente urbano, proporcionando um impacto positivo no ecossistema da cidade!");
        System.out.println();
        System.out.println("Total de lixos coletados e devidamente descastados durante a jornada:" + "\nPlásticos:" + plastico + "\nPapeis:" + papel + "\nMetais:" + metal + "\nVidros:" + vidro);
        System.out.println();
